...
lua_code = talk_prop_code + talk_pages_code      # Concatener le code Lua
### Save Module
talk_module = u'ns_' + nstalk['label']   # enregistrer une table dans le module de l'espace relatif
print lua_code                           # TEST affiche le code du module
#print module_name
#print comment
write_module_lua(talk_module, lua_code)
# # Pas un nouveau module seulement une nlle table dans le module d'origine
