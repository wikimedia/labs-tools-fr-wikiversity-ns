...
subject_module_name = u'ns ' + nsdata['label'].lower()  # nom du module de l'espace en minuscules
#   Talk tables
...
talk_module_name = u'ns ' + nstalk['label'].lower()   # nom du module de l'espace discussion en minuscules
#   Save Modules
