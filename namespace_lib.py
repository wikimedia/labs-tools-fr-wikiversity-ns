...
def ns_collect_data(ns_id):
  ...
  allpages = site.allpages(namespace=ns_id) #subcats = page.subcategories()subcats = page.subcategories()subcats = page.subcategories()subcats = page.subcategories()subcats = page.subcategories()subcats = page.subcategories()subcats = page.subcategories()subcats = page.subcategories()subcats = page.subcategories()subcats = page.subcategories()subcats = page.subcategories(), limit=30)  #TEST # générateur de toutes les pages de l'espace
