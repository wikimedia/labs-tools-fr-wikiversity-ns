...
lcat = get_linked_cat(r_count)
all_sub = get_subcats_in(lcat)
count_recursive(all_sub) #TEST #test = 

##for page in test:
  ##page_prop = test[page]
  ##print page
  ##print page_prop
  ##page_prop['l']   = list(page_prop['gal']) 
...
### Liste des catégories OK
  #[[fr:Catégorie:Langues régionales]]
  #[[fr:Catégorie:Musique]]
  #[[fr:Catégorie:Pédagogie]]
  #[[fr:Catégorie:Tourisme]]
  #[[fr:Catégorie:Sciences cognitives]]
  #[[fr:Catégorie:Audiovisuel]]
  #[[fr:Catégorie:Français]]
  #[[fr:Catégorie:Sport]]
  #[[fr:Catégorie:Infographie]]
  #[[fr:Catégorie:Jeux]]
  #[[fr:Catégorie:langues construites]]
  #[[fr:Catégorie:Biologie]]
  #[[fr:Catégorie:Histoire]]
  #[[fr:Catégorie:Littérature]]
  #[[fr:Catégorie:Transport]]
  #[[fr:Catégorie:Urbanisme]]
  #[[fr:Catégorie:Mathématiques]]
  #[[fr:Catégorie:Théologie]]
  #[[fr:Catégorie:Socio-anthropologie]]
  #[[fr:Catégorie:Psychologie]]
  #[[fr:Catégorie:Langues étrangères]]
  #[[fr:Catégorie:Politique]]
  #[[fr:Catégorie:Langues anciennes]]
  #[[fr:Catégorie:Économie]]
  #[[fr:Catégorie:Médecine]]
  #[[fr:Catégorie:Chimie]]
  #[[fr:Catégorie:Gestion]]
  #[[fr:Catégorie:Sciences de l'ingénieur]]
  #[[fr:Catégorie:Arts plastiques]]
  #[[fr:Catégorie:Physique]]
  #[[fr:Catégorie:Droit]]
  #[[fr:Catégorie:Environnement]]
